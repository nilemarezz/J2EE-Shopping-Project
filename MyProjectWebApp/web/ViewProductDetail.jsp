<%-- 
    ...
    Created on : Nov 1, 2018, 2:59:13 PM
    Author     : Nile
--%>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
                                                    <div class="tab-pane active" id="pic-1"><img src = "book/${product.productcode}.jpg" width="120"></div>
						  
						  
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src = "book/${product.productcode}.jpg"></a></li>
